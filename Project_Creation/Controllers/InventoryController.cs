...
namespace Project_Creation.Controllers
{
    public class InventoryController : Controller
    {
        ...
        private string GenerateSKU(string productName, string categoryName)
        {
            ...
            return $"{namePart}-{catPart}-{TimeZoneInfo.ConvertTimeFromUtc(TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Singapore")), TimeZoneInfo.FindSystemTimeZoneById("Singapore")):MMddHHmm}";
        }
        ...
        public async Task<IActionResult> Create(ProductDto productDto)
        {
            try
            {
                ...
                var product = new Product2
                {
                    ...
                    CreatedAt = TimeZoneInfo.ConvertTimeFromUtc(TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Singapore")), TimeZoneInfo.FindSystemTimeZoneById("Singapore"))
                };
                ...
                try
                {
                    ...
                    var log = new InventoryLog
                    {
                        ...
                        Timestamp = TimeZoneInfo.ConvertTimeFromUtc(TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Singapore")), TimeZoneInfo.FindSystemTimeZoneById("Singapore"))
                    };
        ...
        private async Task<string> SaveBarcodeImage(string imageData, string sku)
        {
            try
            {
                ...
                string fileName = $"barcode_{sku}_{TimeZoneInfo.ConvertTimeFromUtc(TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Singapore")), TimeZoneInfo.FindSystemTimeZoneById("Singapore")):yyyyMMddHHmmss}.png";
        ...
        public async Task<IActionResult> QuickSale()
        {
            try
            {
                ...
                return View(new QuickSaleViewModel
                {
                    ...
                    SaleDate = TimeZoneInfo.ConvertTimeFromUtc(TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Singapore")), TimeZoneInfo.FindSystemTimeZoneById("Singapore"))
                });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> StockIn()
        {
            try
            {
                ...
                return View(new StockInViewModel
                {
                    ...
                    ReceivingDate = TimeZoneInfo.ConvertTimeFromUtc(TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Singapore")), TimeZoneInfo.FindSystemTimeZoneById("Singapore")),
                    Notes = "Stock In"
                });
            }
            catch (Exception ex)
            {
                ...
                // Consider returning an error view or redirecting to a safe page
                return View("Error", new ErrorViewModel
                {
                    RequestId = Activity.Current?.Id ?? HttpContext.TraceIdentifier
                });
        ...
        public async Task<IActionResult> StockIn(StockInViewModel model)
        {
            ...
            try
            {
                ...
                var log = new InventoryLog
                {
                    ...
                    ReferenceId = $"STOCKIN-{TimeZoneInfo.ConvertTimeFromUtc(TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Singapore")), TimeZoneInfo.FindSystemTimeZoneById("Singapore")):yyyyMMddHHmmss}",
